...
exports.getLastfm = (req, res, next) => {
    ...
    Promise.all([
        ...
        const artistInfo = artistInfoRes;
        const artistTopAlbums = artistTopAlbumsRes;
        const artistTopTracks = artistTopTracksRes;
        const artist = {
...
exports.getSteam = (req, res, next) => {
    ...
    const playerAchievements = () => {
        const params = __assign({}, default_params, { appid: '49520' });
    ...
    const playerSummaries = () => {
        const params = __assign({}, default_params, { steamids: steamId });
    ...
    const ownedGames = () => {
        const params = __assign({}, default_params, { include_appinfo: 1, include_played_free_games: 1 });
